/*
  ...
  - Added the required column `updatedAt` to the `guilds` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE `guilds` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
